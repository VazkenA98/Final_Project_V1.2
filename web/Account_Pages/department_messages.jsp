...
<% List<Message> messageList = (List<Message>) request.getAttribute("departmentMessages");%>
<!DOCTYPE html>
<html lang="en">
...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <%for(int i=messageList.size()-1;i>=0;i--){%>
      <%if(messageList.get(i).getPerpose().equals("msg")){%>
      <form action="${pageContext.request.contextPath}/DepartmentMessagesView" method="post" name="secureForm" id="reply_msg<%=i%>">
        <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
        <input type="hidden" name="departmentName" value='<%=request.getAttribute("departmentFullName")%>'>
      ...
      <form method="post" action="DepartmentMessages" id="delete_form">
