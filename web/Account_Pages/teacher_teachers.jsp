...
<% List<Teacher> teacherList = (List<Teacher>) request.getAttribute("teachersList");%>
<!DOCTYPE html>
<html lang="en">
            ...
            <tr>
              ...
              <td>
                <div class="card2" style="background-color: #e6e6e6; padding: 1px;box-shadow: 10px 10px 5px grey;">
                  ...
                  <%}%>
                  <form action="${pageContext.request.contextPath}/TeacherSendEmail" method="post" name="secureForm" id="sendEmailMsg<%=i%>" >
                    <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                    <input type="hidden" name="process" value="check">
