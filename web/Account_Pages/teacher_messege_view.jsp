          ...
          <div style="padding: 10px;display: inline-table;width: 100%; height: 400px; background-color: wheat;">
            ...
            <div style="width: 370px; display: flex;padding: 3px; background-color: white;border-radius: 12px; box-shadow: 10px 10px 5px grey;">
             ...
             <br>
              ...
              <%}%>
                    <hr>
              <form action="${pageContext.request.contextPath}/TeacherSendEmail" method="post" name="secureForm" id="teacherSendEmail_form">
                <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                <input type="hidden" name="teacherName" value='<%=request.getAttribute("teacherFullName")%>'>
                <input type="hidden" name="messageID" value="<%=messageList.get(0).getMessageID()%>">
              ...
              <a class="dropdown-item" style="width: 12%; margin-left: 10px; background-color: #4CAF50; border: none; color: white; border-radius: 25px;" href="#" onclick="document.getElementById('teacherSendEmail_form').submit();">Send Message</a>
                    <hr>
