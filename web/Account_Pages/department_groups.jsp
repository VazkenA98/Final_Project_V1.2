...
<% List<Group> groupList = (List<Group>) request.getAttribute("departmentGroups");%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="card2" style="background-color: #e6e6e6; padding: 1px;box-shadow: 10px 10px 5px grey;">
                                ...
                                <%}%>--%>
                                <form action="${pageContext.request.contextPath}/DepartmentGroupMailing" method="post" name="secureForm" id="sendEmailMsg<%=i%>" >
                                <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
                                <input type="hidden" name="process" value="check">
                                <input type="hidden" name="departmentName" value="<%=request.getAttribute("departmentFullName")%>">
                                ...
                                <form action="${pageContext.request.contextPath}/DepartmentStudents" method="post" name="secureForm" id="viewGroup<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
                                    <input type="hidden" name="departmentName" value="<%=request.getAttribute("departmentFullName")%>">
                                    <input type="hidden" name="msgType" value="msg">
                                ...
                                <form action="${pageContext.request.contextPath}/DepartmentGroupGrades" method="post" name="secureForm" id="grades<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
                                    <input type="hidden" name="departmentName" value="<%=request.getAttribute("departmentFullName")%>">
                                    <input type="hidden" name="groupID" value="<%=groupList.get(i).getId()%>">
                                </form>
                                <form class="user" action="DepartmentGroupAnalysis" method="post" id="groupAnalysis<%=i%>">
                                    <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
                                    <input type="hidden" name="departmentName" value='<%=request.getAttribute("departmentFullName")%>'>
                                    <input type="text" name="groupID" value="<%=groupList.get(i).getId()%>" hidden>
                                </form>
                                ...
                                <p><a class="dropdown-item" style="width: 93%;margin-left: 10px;  background-color: #4CAF50; border: none; color: white; border-radius: 25px;" onclick="document.getElementById('groupAnalysis<%=i%>').submit();" href="#">Analysis</a></p>
