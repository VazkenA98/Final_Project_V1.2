...
<% List<Student> studentList = (List<Student>) request.getAttribute("studentGroupFriends");%>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Group Name : <%=request.getAttribute("studentGroupName")%></h1>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="card2" style="background-color: #e6e6e6; padding: 1px;box-shadow: 10px 10px 5px grey;">
                                ...
                                <%}%>
                                <form action="${pageContext.request.contextPath}/SendEmail" method="post" name="secureForm" id="sendEmail<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("studentSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
