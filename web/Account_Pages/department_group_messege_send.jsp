    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <!-- Begin Page Content -->
          ...
          <div class="main_div">
            ...
            <%}else{%>
            <form class="user" action="DepartmentGroupMailing" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" name="reciver" value="<%=request.getAttribute("groupName")%>" class="form-control form-control-user" style="width: 300px; font-size: 16px; color: black;" id="exampleInputReciver" aria-describedby="emailHelp" placeholder="To :" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="file" name="file" class="file_but" multiple="multiple"/>
              <input type="hidden" name="id" value='<%=session.getAttribute("departmentSessionID")%>'>
              <input type="hidden" name="teacherName" value='<%=request.getAttribute("departmentFullName")%>'>
