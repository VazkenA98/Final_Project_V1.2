...
<% List<Student> studentList = (List<Student>) request.getAttribute("teacherStudents");%>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="card2" style="background-color: #e6e6e6; padding: 1px;box-shadow: 10px 10px 5px grey;">
                                    ...
                                    <p class="title"><%=studentList.get(i).getNationality()%></p>
                                    ...
                                    <form action="${pageContext.request.contextPath}/TeacherSendEmail" method="post" name="secureForm" id="sendEmailHomeWork<%=i%>" >
                                        <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                                        <input type="hidden" name="process" value="check">
                                        <input type="hidden" name="reciverEmail" value='<%=studentList.get(i).getRecover_email()%>'>
                                        <input type="hidden" name="teacherName" value="<%=request.getAttribute("teacherFullName")%>">
