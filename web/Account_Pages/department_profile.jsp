...
<% List<Department> departmentList = (List<Department>) request.getAttribute("departmentInfo");%>
<!DOCTYPE html>
<html lang="en">
          ...
          <table class="table">
                    ...
                    <tbody class="tbody1">
                      <tr>
                        ...
                        <th class="th"><label title="First Name" value="First Name" ><%=departmentList.get(0).getName()%></label></th>
                      </tr>
                       <tr>
                        <th class="th"><label title="Last Name" value="Last Name" >Last Name</label></th>
                        <th class="th"><label title="Last Name" value="Last Name" ><%=departmentList.get(0).getSurname()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Birth Date" value="Birth Date" >ID</label></th>
                        <th class="th"><label title="Birth Date" value="Birth Date" ><%=departmentList.get(0).getCustem_ID()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Birth Date" value="Birth Date" >Birth Date</label></th>
                        <th class="th"><label title="Birth Date" value="Birth Date" ><%=departmentList.get(0).getBirth_date()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Birth Date" value="Birth Date" >Nationality</label></th>
                        <th class="th"><label title="Birth Date" value="Birth Date" ><%=departmentList.get(0).getNationality()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Gender" value="Gender" >Gender</label></th>
                        <th class="th"><label title="Gender" value="Gender" ><%=departmentList.get(0).getGender()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Mail" value="Mail" >Department Email</label></th>
                        <th class="th"><label title="Mail" value="Mail" ><%=departmentList.get(0).getEmail()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Mail" value="Mail" >Recovery Email</label></th>
                        <th class="th"><label title="Mail" value="Mail" ><%=departmentList.get(0).getRecover_email()%></label></th>
                      </tr>
                      <tr>
                      <th class="th"><label value="Phone" title="Phone"><a class="Phone"  href="tel:<%=departmentList.get(0).getPhone()%>">Phone</a></label></th>
                      <th class="th"><label title="Phone" value="Phone"><%=departmentList.get(0).getPhone()%></label></th>
                      </tr>
                      <tr>
                        <th class="th"><label title="Possition" value="Possition" >Possition</label></th>
                        <th class="th"><label title="Possition" value="Possition" >Head Of Department</label></th>
                      </tr>
