...
<% List<Group> groupList = (List<Group>) request.getAttribute("teacherGroups");%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="card2" style="background-color: #e6e6e6; padding: 1px;box-shadow: 10px 10px 5px grey;">
                                <h1 style="font-size: 28px"><b><%=groupList.get(i).getName()%></b></h1>
                                <p class="title"><%=groupList.get(i).getGroupCourse()%></p>
                                <%--<% if(groupList.get(i).getOnline_status() == 0){%>
                                <p style="color: #dc3545">Offline</p>
                                <%}else{%>
                                <p style="color: #1cc88a">Online</p>
                                <%}%>--%>
                                <form action="${pageContext.request.contextPath}/TeacherGroupMailing" method="post" name="secureForm" id="sendEmailMsg<%=i%>" >
                                <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                                <input type="hidden" name="process" value="check">
                                <input type="hidden" name="teacherName" value="<%=request.getAttribute("teacherFullName")%>">
                                <input type="hidden" name="msgType" value="msg">
                                <input type="hidden" name="groupID" value="<%=groupList.get(i).getId()%>">
                                <input type="hidden" name="groupName" value="<%=groupList.get(i).getName()%>">
                            </form>

                                <form action="${pageContext.request.contextPath}/TeacherGroupMailing" method="post" name="secureForm" id="sendEmailHomework<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
                                    <input type="hidden" name="teacherName" value="<%=request.getAttribute("teacherFullName")%>">
                                ...
                                <form action="${pageContext.request.contextPath}/TeacherStudents" method="post" name="secureForm" id="viewGroup<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
                                    <input type="hidden" name="teacherName" value="<%=request.getAttribute("teacherFullName")%>">
                                    <input type="hidden" name="msgType" value="msg">
                                ...
                                <form action="${pageContext.request.contextPath}/TeacherStudentsGrades" method="post" name="secureForm" id="grades<%=i%>" >
                                    <input type="hidden" name="id" value='<%=session.getAttribute("teacherSessionID")%>'>
                                    <input type="hidden" name="process" value="check">
                                    <input type="hidden" name="teacherName" value="<%=request.getAttribute("teacherFullName")%>">
                                    <input type="hidden" name="groupID" value="<%=groupList.get(i).getId()%>">
                                ...
                                <p><a class="dropdown-item" style="width: 93%;margin-left: 10px;  background-color: #4CAF50; border: none; color: white; border-radius: 25px;" onclick="document.getElementById('sendEmailHomework<%=i%>').submit();" href="#">Send Homework</a></p>
                                    <p><a class="dropdown-item" style="width: 93%;margin-left: 10px;  background-color: #4CAF50; border: none; color: white; border-radius: 25px;" onclick="document.getElementById('viewGroup<%=i%>').submit();" href="#">View</a></p>
                                <p><a class="dropdown-item" style="width: 93%;margin-left: 10px;  background-color: #4CAF50; border: none; color: white; border-radius: 25px;" onclick="document.getElementById('grades<%=i%>').submit();" href="#">Grades</a></p>
